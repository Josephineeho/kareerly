...
function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const sidebarMenu = [
    { icon: <LayoutDashboard size={19} />, link: "/dashboard", label: "Dashboard" },
    { icon: <FileUser size={19} />, link: "/dashboard/applications", label: "Applications" },
    { icon: <Bookmark size={19} />, link: "/dashboard/saved-jobs", label: "Saved Jobs" },
    { icon: <Mail size={19} />, link: "/dashboard/messages", label: "Messages" },
    { icon: <UserCircle2 size={19} />, link: "/dashboard/profile", label: "Profile" },
    { icon: <BriefcaseBusiness size={19} />, link: "/dashboard/jobs", label: "Jobs" },
    { icon: <Building2Icon size={19} />, link: "/dashboard/companies", label: "Companies" },
    { icon: <Settings size={19} />, link: "/dashboard/settings", label: "Settings" },
  ];
